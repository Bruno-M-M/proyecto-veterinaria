...
/**
 * Cargar opciones de Región en el select al inicializar el script
 */
...
// Ejecutamos la carga de regiones al inicio
cargarRegiones();

/**
 * Evento al cambiar la selección de Región para filtrar las Comunas
 */
